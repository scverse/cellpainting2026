...
- Take the S-Bahn S2 (direction Bernau) to Berlin-Buch station, then bus 353 (direction "Campus Buch") to the stop on campus. Buses 150, 158, and 259 also serve the area.
- Berlin-Buch is in fare zone B, covered by a standard Berlin AB ticket. If you stay just over the border in Brandenburg (e.g. Panketal), the local stations are in zone C, so you'll need an ABC ticket.
- Full venue directions: [How to get to Berlin-Buch (MDC)](https://www.mdc-berlin.de/travel-directions). Campus address: Robert-Rössle-Straße 10, 13125 Berlin.

## Questions?

Any questions about getting here or finding a place to stay? Just reply to your invitation email or reach out on the hackathon [Zulip channel](https://scverse.zulipchat.com/#narrow/channel/591503-2026-09.3A-hackathon-cellpainting). We're happy to help.
